...
public class LancamentoFinanceiroController extends DaoImplementacao<LancamentoFinanceiro>
		implements DaoInterface<LancamentoFinanceiro> {
	
	public LancamentoFinanceiroController(Class<LancamentoFinanceiro> persistenceClass) {
	...
	public ResponseEntity salvar(@RequestBody String jsonPost)
			throws Exception{
		LancamentoFinanceiro objeto = new Gson().fromJson(jsonPost,
	...
	public ResponseEntity atualizar(@RequestBody String jsonPut)
			throws Exception{
		LancamentoFinanceiro objeto = new Gson().fromJson(jsonPut, LancamentoFinanceiro.class);
	...
	String buscar(@PathVariable("id") String id)
			throws Exception {
		LancamentoFinanceiro objeto = super.loadObjeto(Long.parseLong(id));
		if (objeto == null) {
			return "{}";
		}
