...
@Controller
@RequestMapping(value = "/pessoacondominio")
public class PessoaCondominioController extends DaoImplementacao<PessoaCondominio>
		implements DaoInterface<PessoaCondominio> {
	
	public PessoaCondominioController(Class<PessoaCondominio> persistenceClass) {
	...
	public ResponseEntity salvar(@RequestBody String jsonPost)
			throws Exception{
		PessoaCondominio objeto = new Gson().fromJson(jsonPost,
				PessoaCondominio.class);
	...
	public ResponseEntity atualizar(@RequestBody String jsonPut)
			throws Exception{
		PessoaCondominio objeto = new Gson().fromJson(jsonPut, PessoaCondominio.class);
	...
	String buscar(@PathVariable("id") String id)
			throws Exception {
		PessoaCondominio objeto = super.loadObjeto(Long.parseLong(id));
		if (objeto == null) {
			return "{}";
		}
